...
export class CheckoutService {
  ...
  private purchaseUrl = 'https://ecommerce-spring-boot-production-b949.up.railway.app/api/checkout/purchase';
  private cancelOrderUrl = 'https://ecommerce-spring-boot-production-b949.up.railway.app/api/checkout/cancelLatestOrder';
  private reportsUrl = 'https://ecommerce-spring-boot-production-b949.up.railway.app/api/orders/reports';
  ...
  cancelLatestOrder(): Observable<string> {
    return this.httpClient.delete<string>('https://ecommerce-spring-boot-production-b949.up.railway.app/api/checkout/cancelLatestOrder', { responseType: 'text' as 'json' });
  }
